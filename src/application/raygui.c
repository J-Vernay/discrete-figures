// Manually seperated from raygui.h, and modified to suit needs.
...
bool GuiButton_EX_State(Rectangle bounds, const char *text, GuiControlState state)
{
    bool pressed = false;
...
bool GuiButton(Rectangle bounds, const char* text) {
    return GuiButton_EX_State(bounds, text, guiState);
}
